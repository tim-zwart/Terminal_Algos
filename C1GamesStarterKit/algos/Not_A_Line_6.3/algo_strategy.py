...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def on_game_start(self, config,game_state_string):
        ...
        self.destructor_locations = [[ 2, 11],[ 7, 11],[ 8, 11],[ 13, 11],[ 14, 11],[ 19, 11],[ 20, 11],[ 25, 11],[ 3, 10],[ 24, 10],[ 4, 9],[ 23, 9],[ 7, 8],[ 9, 8],[ 11, 8],[ 13, 8],[ 14, 8],[ 16, 8],[ 18, 8],[ 20, 8]]
        self.filter_locations = [[ 0, 13],[ 27, 13],[ 1, 12],[ 2, 12],[ 7, 12],[ 8, 12],[ 13, 12],[ 14, 12],[ 19, 12],[ 20, 12],[ 25, 12],[ 26, 12],[ 3, 11],[ 6, 11],[ 9, 11],[ 12, 11],[ 15, 11],[ 18, 11],[ 21, 11],[ 24, 11],[ 4, 10],[ 23, 10],[ 5, 9],[ 7, 9],[ 9, 9],[ 11, 9],[ 13, 9],[ 14, 9],[ 16, 9],[ 18, 9],[ 20, 9],[ 22, 9]]
        self.encryptor_locations = [[ 5, 8],[ 22, 8],[ 9, 6],[ 10, 6],[ 11, 6],[ 12, 6],[ 15, 6],[ 16, 6],[ 17, 6],[ 18, 6],[ 10, 5],[ 11, 5],[ 12, 5],[ 15, 5],[ 16, 5],[ 17, 5],[ 11, 4],[ 12, 4],[ 15, 4],[ 16, 4]]
                ...
                if game_state.contains_stationary_unit(build.loc):
                    ...
                    if build.unit_type == FILTER:
                        ...
                        if game_state.turn_number == 0:
                            if build.loc[1] == 8 and build.loc[0] != 13 and build.loc[0] != 14:
