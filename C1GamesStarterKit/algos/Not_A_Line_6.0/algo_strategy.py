...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def on_game_start(self, config,game_state_string):
        ...
        self.destructor_locations = [[ 2, 11],[ 7, 11],[ 11, 11],[ 16, 11],[ 20, 11],[ 25, 11],[ 3, 10],[ 24, 10],[ 4, 9],[ 23, 9],[ 5, 8],[ 8, 8],[ 12, 8],[ 15, 8],[ 19, 8],[ 22, 8]]
        self.filter_locations = [[ 0, 13],[ 27, 13],[ 1, 12],[ 2, 12],[ 7, 12],[ 11, 12],[ 16, 12],[ 20, 12],[ 25, 12],[ 26, 12],[ 3, 11],[ 6, 11],[ 8, 11],[ 10, 11],[ 12, 11],[ 15, 11],[ 17, 11],[ 19, 11],[ 21, 11],[ 24, 11],[ 4, 10],[ 23, 10],[ 5, 9],[ 8, 9],[ 12, 9],[ 15, 9],[ 19, 9],[ 22, 9],[ 7, 8],[ 9, 8],[ 11, 8],[ 16, 8],[ 18, 8],[ 20, 8]]
        self.encryptor_locations = [[ 8, 7],[ 9, 7],[ 11, 7],[ 12, 7],[ 15, 7],[ 16, 7],[ 18, 7],[ 19, 7],[ 9, 6],[ 11, 6],[ 12, 6],[ 15, 6],[ 16, 6],[ 18, 6],[ 11, 5],[ 12, 5],[ 15, 5],[ 16, 5],[ 11, 4],[ 12, 4],[ 15, 4],[ 16, 4],[ 12, 3],[ 15, 3]]
        ...
        for loc in self.destructor_locations:
            ...
            for filter in self.filter_locations:
                if self.ideal_map.distance_between_locations(loc, filter) == 1 or self.ideal_map.distance_between_locations(loc, filter) == sqrt(2) or (loc == [25, 11] and filter == [27, 13]) or (loc == [2, 11] and filter == [0, 13]):
    ...
    def build_base_defences(self, game_state):
        ...
        necessary_sets = []
        emp_path = game_state.find_path_to_edges(self.emp_spawn_loc)
        ...
        for build_set in self.build_sets:
            ...
            if n_missing > 0:
                ...
                if any_built:
                    ...
                    if game_state.turn_number == 4 and build_set.build_list[0].loc == [3, 10]:
                        gamelib.debug_write("Destructor has a probability {}".format(build_set.probability))
