...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def deploy_attackers(self, game_state):
        ...
        #path = game_state.find_path_to_edge(start_loc, game_state.game_map.TOP_RIGHT)
        #Checkpoints
        ...
        elif(game_state.number_affordable(PING) >= 5 + bonus and not directed_attack):
            game_state.attempt_spawn(PING, [7,6], game_state.number_affordable(PING))
