...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def build_base_defences(self, game_state):
        destructor_locations = [[ 1, 12],[ 2, 12],[ 24, 12],[ 2, 11],[ 3, 11],[ 23, 11],[ 5, 10],[ 9, 10],[ 12, 10],[ 15, 10],[ 18, 10],[ 22, 10]]
        filter_locations = [[ 0, 13],[ 1, 13],[ 2, 13],[ 24, 13],[ 25, 13],[ 26, 13],[ 27, 13],[ 3, 12],[ 23, 12],[ 25, 12],[ 26, 12],[ 4, 11],[ 5, 11],[ 9, 11],[ 12, 11],[ 15, 11],[ 18, 11],[ 22, 11],[ 25, 11],[ 6, 10],[ 7, 10],[ 8, 10],[ 10, 10],[ 11, 10],[ 13, 10],[ 14, 10],[ 16, 10],[ 17, 10],[ 19, 10],[ 20, 10],[ 21, 10]]
        encryptor_locations = [[ 11, 8],[ 12, 8],[ 13, 8],[ 14, 8],[ 15, 8],[ 16, 8],[ 17, 8],[ 18, 8],[ 19, 8],[ 20, 8],[ 21, 8],[ 11, 7],[ 12, 7],[ 13, 7],[ 14, 7],[ 15, 7],[ 16, 7],[ 17, 7],[ 18, 7],[ 19, 7],[ 20, 7],[ 21, 7],[ 11, 6],[ 12, 6],[ 13, 6],[ 14, 6],[ 15, 6],[ 16, 6],[ 17, 6],[ 18, 6],[ 19, 6],[ 20, 6]]
    ...
    def deploy_attackers(self, game_state):
        ...
        if(directed_attack or self.flank_attack):
            blocked = False
            ...
            if(blocked and game_state.project_future_bits(1, 0, game_state.get_resource(game_state.BITS, 0) >= 12)):
        ...
        elif(game_state.number_affordable(EMP) >= 2):
            game_state.attempt_spawn(EMP, start_loc, game_state.number_affordable(EMP))
